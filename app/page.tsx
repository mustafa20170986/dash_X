...
const dashboards = [
  {
    ...
    description:
      "Comprehensive overview of your software's performance, user growth, and revenue streams.",
    features: [
      "KPI Cards",
      "Revenue Charts",
      "Monthly Growth",
  ...
  },
  {
    ...
    title: "CRM Dashboard",
    description:
      "Manage your customers, sales pipeline, and team performance in one centralized hub.",
    features: [
      "Customer List",
      "Sales Pipeline",
      "Tasks & Calendar",
  ...
  },
  {
    ...
    description:
      "Track income, expenses, and profit with real-time data visualization and budgeting tools.",
    features: [
  ...
  },
  {
    ...
    description:
      "Keep track of stock levels, suppliers, and orders with automated alerts and analytics.",
    features: [
      "Product Tracking",
      "Low Stock Alerts",
      "Supplier Management",
  ...
  },
  {
    ...
    description:
      "Streamline employee management, attendance, leave requests, and payroll reviews.",
    features: [
      "Employee Directory",
      "Attendance Tracking",
      "Leave Management",
      ...
      <footer className="border-t py-12 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          <p className="text-muted-foreground">
            © 2026 DashVault. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
